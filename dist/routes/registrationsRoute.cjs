...
// src/routes/registrationsRoute.ts
var registrationsRoute_exports = {};
__export(registrationsRoute_exports, {
  registrations: () => router
});
module.exports = __toCommonJS(registrationsRoute_exports);
